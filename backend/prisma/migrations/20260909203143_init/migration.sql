...
-- CreateEnum
CREATE TYPE "PoliceClearanceStatus" AS ENUM ('PENDING', 'SUBMITTED', 'RECEIVED', 'REJECTED', 'EXPIRED', 'NOT_REQUIRED');
...
CREATE TABLE "police_clearances" (
    ...
    "status" "PoliceClearanceStatus" NOT NULL DEFAULT 'PENDING',
    "file_id" TEXT,
...
-- AddForeignKey
ALTER TABLE "police_clearances" ADD CONSTRAINT "police_clearances_file_id_fkey" FOREIGN KEY ("file_id") REFERENCES "file_registry"("id") ON DELETE SET NULL ON UPDATE CASCADE;
